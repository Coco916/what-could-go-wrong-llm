...
9. There is 3 "rapid-fire" white cards, if a player draw it, he has to reveal it, the next roudn will be "rapid-fire" which mean there is only 30seconds to think and put his white card in his slot. The player who revealed this "rapid-fire card" must draw another white card as the rapid-fire card can't be part of any player's hand (it is also discarded when drew to make every player aware of this change for the round).
